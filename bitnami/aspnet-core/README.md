...
```console
helm install my-release oci://MY-OCI-REGISTRY/aspnet-core
```
...
| `appFromExternalRepo.clone.fips.openssl`        | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used | `""`                                                 |
...
| `appFromExternalRepo.publish.fips.openssl`      | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used | `""`                                                 |
