...
```console
helm install my-release oci://MY-OCI-REGISTRY/pytorch
```
...
| `git.fips.openssl`                    | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                                    | `""`                       |
