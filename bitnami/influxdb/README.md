...
This chart supports configuring TLS encryption for InfluxDB&trade; Core connections by setting `tls.enabled` parameter to `true`.
...
| `createAdminTokenJob.fips.openssl`                                      | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                                                                                     | `""`                       |
| `createAdminTokenJob.fips.golang`                                       | Configure Golang FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                                                                                      | `relaxed`                  |
