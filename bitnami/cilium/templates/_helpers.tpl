...
{{/*
Return the name of the secret containing the CA TLS certificate for Hubble
*/}}
{{- define "cilium.hubble.tls.ca.secretName" -}}
{{- if and (not .Values.hubble.tls.autoGenerated.enabled) (empty .Values.hubble.tls.ca) -}}
    {{- required "An existing secret name must be provided with a CA cert for Hubble if cert is not provided!" (tpl .Values.hubble.tls.existingCASecret .) -}}
{{- end -}}
