...
```console
helm install my-release oci://MY-OCI-REGISTRY/kiam
```
...
| `agent.fips.golang`                                       | Configure Golang FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                             | `relaxed`                 |
