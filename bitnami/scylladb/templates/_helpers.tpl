...
{{- if and (include "scylladb.tls.enabled" .) (not .Values.tls.autoGenerated.enabled) (not .Values.tls.existingSecret) }}
...
{{- default "none" .Values.tls.internodeEncryption -}}
{{- end -}}

{{/*
Return true if encryption via TLS should be configured
*/}}
{{- define "scylladb.tls.enabled" -}}
...
*/}}
{{- define "scylladb.tls.secretName" -}}
{{- if or .Values.tls.autoGenerated.enabled (and (not (empty .Values.tls.cert)) (not (empty .Values.tls.key))) -}}
    {{- printf "%s-crt" (include "common.names.fullname" .) -}}
{{- else -}}
    {{- required "An existing secret name must be provided with TLS certs for Scylladb if cert and key are not provided!" (tpl .Values.tls.existingSecret .) -}}
{{- end -}}
{{- end -}}
