...
*/}}
{{- define "keydb.tls.ca.secretName" -}}
{{- if and (not .Values.tls.autoGenerated.enabled) (empty .Values.tls.ca) -}}
    {{- required "An existing secret name must be provided with a CA cert for KeyDB if cert is not provided!" (tpl .Values.tls.existingCASecret .) -}}
{{- end -}}
