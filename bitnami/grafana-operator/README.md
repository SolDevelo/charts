...
```console
helm install my-release oci://MY-OCI-REGISTRY/grafana-operator
```
...
| `grafana.fips.openssl`                                      | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                | `""`                      |
| `grafana.fips.golang`                                       | Configure Golang FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                 | `relaxed`                 |
