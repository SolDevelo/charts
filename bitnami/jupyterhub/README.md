...
```console
helm install my-release oci://MY-OCI-REGISTRY/jupyterhub
```
...
| `hub.fips.openssl`                                      | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                        | `""`                         |
...
| `proxy.tls.enabled`                                       | If disabled, the configurable-http-proxy container will be configured without HTTP certificates                                                                                                                               | `false`                                   |
| `proxy.tls.existingSecret`                                | Name of a Secret containing the proxy TLS certificates                                                                                                                                                                        | `""`                                      |
...
| `proxy.fips.openssl`                                      | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                            | `""`                                      |
...
| `singleuser.fips.openssl`                                      | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                      | `""`                                    |
