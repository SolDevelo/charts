...
| `dremio.tls.autoGenerated.enabled`                        | Enable automatic generation of TLS certificates                                                                                                                                                                                                     | `true`                   |
| `dremio.tls.autoGenerated.engine`                         | Mechanism to generate the certificates (allowed values: helm, cert-manager)                                                                                                                                                                         | `helm`                   |
| `dremio.tls.autoGenerated.extraSANs`                      | Extra Subject Alternative Names (SANs) for generated certificates                                                                                                                                                                                   | `[]`                     |
| `dremio.tls.autoGenerated.loopback`                       | Add loopback SANs (localhost and 127.0.0.1) to generated certificates                                                                                                                                                                               | `false`                  |
...
| `masterCoordinator.fips.openssl`                                      | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                                                       | `""`                   |
| `masterCoordinator.fips.java`                                         | Configure JAVA FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                                                          | `off`                  |
...
| `coordinator.fips.openssl`                                      | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                                    | `""`                   |
| `coordinator.fips.java`                                         | Configure JAVA FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                                       | `off`                  |
...
| `executor.fips.java`                                                | Configure JAVA FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                                    | `off`            |
...
| `bootstrapUserJob.fips.openssl`                                      | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                                  | `""`             |
...
| `defaultInitContainers.wait.fips.openssl`                                                 | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                                  | `""`                       |
...
| `defaultInitContainers.generateConf.fips.openssl`                                         | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                                  | `""`                       |
...
| `defaultInitContainers.initCerts.fips.java`                                               | Configure JAVA FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                                     | `off`                      |
...
| `defaultInitContainers.copyDefaultConf.fips.openssl`                                      | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                                  | `""`                       |
...
| `defaultInitContainers.upgradeKeystore.fips.openssl`                                      | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                                  | `""`                       |
| `defaultInitContainers.upgradeKeystore.fips.java`                                         | Configure JAVA FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                                     | `off`                      |
...
| `minio.console.fips.openssl`       | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                | `""`                                                |
| `minio.console.fips.golang`        | Configure Golang FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                 | `relaxed`                                           |
...
| `metrics.fips.java`                                         | Configure JAVA FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                            | `restricted`                   |
...
| `zookeeper.fips.java`             | Configure JAVA FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                            | `restricted` |
