...
| `alloy.tls.ca`                                            | CA certificate for TLS.                                                                                                                                                                                                              | `""`                            |
...
| `alloy.tls.extraSANs`                                     | Extra Subject Alternative Names (SANs) for the TLS certificate                                                                                                                                                                       | `[]`                            |
| `alloy.tls.autoGenerated.enabled`                         | Enable automatic generation of certificates for TLS                                                                                                                                                                                  | `true`                          |
