...
{{- if or .Values.alloy.tls.autoGenerated.enabled (and (not (empty .Values.alloy.tls.cert)) (not (empty .Values.alloy.tls.key))) -}}
    {{- printf "%s-crt" (include "common.names.fullname" .) -}}
{{- else -}}
    {{- required "An existing secret name must be provided with TLS certs for Grafana Alloy if cert and key are not provided!" (tpl .Values.alloy.tls.existingSecret .) -}}
{{- end -}}
{{- end -}}
