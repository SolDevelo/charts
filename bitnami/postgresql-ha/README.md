...
```console
helm install my-release oci://MY-OCI-REGISTRY/postgresql-ha
```
...
| `postgresql.fips.openssl`                                      | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                      | `""`                                |
...
| `postgresql.livenessProbe.initialDelaySeconds`                 | Initial delay seconds for livenessProbe                                                                                                                                                                                                 | `20`                                |
...
| `postgresql.livenessProbe.failureThreshold`                    | Failure threshold for livenessProbe                                                                                                                                                                                                     | `3`                                 |
...
| `postgresql.readinessProbe.initialDelaySeconds`                | Initial delay seconds for readinessProbe                                                                                                                                                                                                | `10`                                |
...
| `postgresql.readinessProbe.failureThreshold`                   | Failure threshold for readinessProbe                                                                                                                                                                                                    | `3`                                 |
...
| `postgresql.extraInitContainers`                               | Extra init containers (DEPRECATED, use `postgresql.initContainers` instead)                                                                                                                                                             | `[]`                                |
...
| `postgresql.extendedConf`                                      | Extended PostgreSQL configuration (requires `defaultInitContainers.volumePermissions.enabled` to be `true`)                                                                                                                             | `""`                                |
| `postgresql.extendedConfCM`                                    | ConfigMap with PostgreSQL extended configuration (requires `defaultInitContainers.volumePermissions.enabled` to be `true`)                                                                                                              | `""`                                |
...
| `witness.fips.openssl`                                         | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                      | `""`                                |
...
| `witness.extraInitContainers`                                  | Extra init containers (DEPRECATED, use `witness.initContainers` instead)                                                                                                                                                                | `[]`                                |
...
| `witness.extendedConf`                                         | Extended PostgreSQL configuration (requires `defaultInitContainers.volumePermissions.enabled` to be `true`)                                                                                                                             | `""`                                |
| `witness.extendedConfCM`                                       | ConfigMap with PostgreSQL extended configuration (requires `defaultInitContainers.volumePermissions.enabled` to be `true`)                                                                                                              | `""`                                |
...
| `pgpool.fips.openssl`                                      | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                              | `""`                     |
...
| `pgpool.autoFailBack`                                      | Enable Pgpool-II auto_failback on false primaries detection                                                                                                                                                                     | `false`                  |
...
| `serviceAccount.automountServiceAccountToken` | Whether pods running as this ServiceAccount should have an API token automatically mounted | `false` |
| `rbac.create`                                 | Create Role and RoleBinding with custom RBAC rules for the PostgreSQL HA ServiceAccount    | `false` |
...
| Name                                                        | Description                                                                                                                                                                                                                                                      | Value                               |
| ----------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- |
| `metrics.enabled`                                           | Enable the export of Prometheus metrics using the PostgreSQL Prometheus exporter                                                                                                                                                                                 | `false`                             |
...
| `metrics.image.debug`                                       | Enable PostgreSQL Prometheus exporter debug mode                                                                                                                                                                                                                 | `false`                             |
| `metrics.containerSecurityContext.enabled`                  | Enabled PostgreSQL Prometheus exporter container' Security Context                                                                                                                                                                                               | `true`                              |
| `metrics.containerSecurityContext.seLinuxOptions`           | Set SELinux options in PostgreSQL Prometheus exporter container                                                                                                                                                                                                  | `{}`                                |
| `metrics.containerSecurityContext.runAsUser`                | Set runAsUser in PostgreSQL Prometheus exporter container' Security Context                                                                                                                                                                                      | `1001`                              |
| `metrics.containerSecurityContext.runAsGroup`               | Set runAsGroup in PostgreSQL Prometheus exporter container' Security Context                                                                                                                                                                                     | `1001`                              |
| `metrics.containerSecurityContext.runAsNonRoot`             | Set runAsNonRoot in PostgreSQL Prometheus exporter container' Security Context                                                                                                                                                                                   | `true`                              |
| `metrics.containerSecurityContext.readOnlyRootFilesystem`   | Set readOnlyRootFilesystem in PostgreSQL Prometheus exporter container' Security Context                                                                                                                                                                         | `true`                              |
| `metrics.containerSecurityContext.privileged`               | Set privileged in PostgreSQL Prometheus exporter container' Security Context                                                                                                                                                                                     | `false`                             |
| `metrics.containerSecurityContext.allowPrivilegeEscalation` | Set allowPrivilegeEscalation in PostgreSQL Prometheus exporter container' Security Context                                                                                                                                                                       | `false`                             |
| `metrics.containerSecurityContext.capabilities.drop`        | List of capabilities to be dropped in PostgreSQL Prometheus exporter container                                                                                                                                                                                   | `["ALL"]`                           |
| `metrics.containerSecurityContext.seccompProfile.type`      | Set seccomp profile in PostgreSQL Prometheus exporter container                                                                                                                                                                                                  | `RuntimeDefault`                    |
| `metrics.resourcesPreset`                                   | Set PostgreSQL Prometheus exporter container resources according to one common preset (allowed values: none, nano, micro, small, medium, large, xlarge, 2xlarge). This is ignored if metrics.resources is set (metrics.resources is recommended for production). | `nano`                              |
| `metrics.resources`                                         | Set PostgreSQL Prometheus exporter container requests and limits for different resources like CPU or memory (essential for production workloads)                                                                                                                 | `{}`                                |
...
| `metrics.containerPorts.http`                               | PostgreSQL Prometheus exporter port                                                                                                                                                                                                                              | `9187`                              |
...
| `service.extraPorts`               | Extra ports to expose (normally used with the `postgresql.sidecars` or `pgpool.sidecars` values) | `[]`         |
| `service.sessionAffinity`          | Control where client requests go, to the same pod or round-robin                                 | `None`       |
| `service.sessionAffinityConfig`    | Additional settings for the sessionAffinity                                                      | `{}`         |
| `service.annotations`              | Additional custom annotations for PostgreSQL and Pgpool-II services                              | `{}`         |
| `service.serviceLabels`            | Additional custom labels for PostgreSQL and Pgpool-II services                                   | `{}`         |
| `service.headless.annotations`     | Additional custom annotations for the headless service.                                          | `{}`         |
...
| `defaultInitContainers.setup.resourcesPreset`                                               | Set PostgreSQL "setup" init container resources according to one common preset (allowed values: none, nano, micro, small, medium, large, xlarge, 2xlarge). This is ignored if defaultInitContainers.setup.resources is set (defaultInitContainers.setup.resources is recommended for production).                           | `micro`                    |
| `defaultInitContainers.setup.resources`                                                     | Set PostgreSQL "setup" init container requests and limits for different resources like CPU or memory (essential for production workloads)                                                                                                                                                                                   | `{}`                       |
| `defaultInitContainers.setup.fips.openssl`                                                  | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                                                                                                          | `""`                       |
| `defaultInitContainers.setup.startupWaitOptions`                                            | Override default builtin startup wait check options for PostgreSQL "setup" init container                                                                                                                                                                                                                                   | `{}`                       |
...
| `defaultInitContainers.volumePermissions.fips.openssl`                                      | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                                                                                                          | `""`                       |
...
```console
$ helm upgrade mypg oci://MY-OCI-REGISTRY/postgresql-ha \
