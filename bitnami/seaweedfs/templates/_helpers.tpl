...
{{- if and (not .Values.security.mTLS.autoGenerated.enabled) (empty .Values.security.mTLS.ca) -}}
...
{{- if or .Values.webdav.tls.autoGenerated.enabled (and (not (empty .Values.webdav.tls.cert)) (not (empty .Values.webdav.tls.key))) -}}
