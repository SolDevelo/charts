...
```console
helm install my-release oci://MY-OCI-REGISTRY/clickhouse-operator
```
...
| `clickHouseImage.fips.openssl`                      | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                             | `""`                                  |
...
| `keeperImage.fips.openssl`                          | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                             | `""`                                  |
